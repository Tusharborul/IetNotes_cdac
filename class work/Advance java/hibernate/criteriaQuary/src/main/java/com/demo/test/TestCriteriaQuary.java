...
public class TestCriteriaQuary {
	...
	public static void main(String[] args) {
		...
		Criterion cr2=Restrictions.gt("quantity", 15);
		...
		Criterion cr12=Restrictions.gt("price", 2000f);
		Criterion cr13=Restrictions.lt("price", 7000f);
		Criterion cr14=Restrictions.le("quantity", 20);
